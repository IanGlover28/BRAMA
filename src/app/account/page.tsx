  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-500 rounded-xl shadow-lg p-6 mb-6 sticky top-20 z-10">
          <div className="flex items-center justify-between">
            ...
            {user ? (
              <button
                ...
                className="flex items-center gap-2 bg-white text-green-600 px-5 py-2.5 rounded-full hover:bg-green-50 transition font-semibold"
              >
                <LogOut size={18} />
                Sign Out
              </button>
...
function AccountMenuItem({ icon: Icon, label, description, onClick }: AccountMenuItemProps) {
  return (
    <button
      onClick={onClick}
      className="flex items-start gap-4 p-4 rounded-lg border border-gray-200 hover:border-green-500 hover:bg-green-50 transition-all group text-left"
    >
      ...
      <ChevronRight size={20} className="text-gray-400 group-hover:text-green-600 transition flex-shrink-0 mt-1" />
    </button>
  );
}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <Icon size={20} className={danger ? 'text-red-600' : 'text-green-600'} />
